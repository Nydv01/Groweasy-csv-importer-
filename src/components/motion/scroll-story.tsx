...
export function ScrollStory() {
  ...
  // Determine active stage from scroll progress
  useEffect(() => {
  ...
  const opacity0 = useTransform(smoothProgress, [0, 0.15, 0.3, 0.33], [0, 1, 1, 0]);
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 48 }}>
          {STAGES.map((stage, i) => (
            <div key={i} style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              ...
              <div>
                <h3 className="text-heading" style={{ marginBottom: 4 }}>{stage.title}</h3>
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <motion.div
            style={{ opacity: opacity0, position: 'absolute' }}
          >
          ...
          <motion.div
            style={{ opacity: opacity2, position: 'absolute' }}
          >
            <div style={{
              display: 'grid',
          ...
          <div>
            {STAGES.map((stage, i) => (
              <motion.div
                ...
                style={{ marginBottom: i < STAGES.length - 1 ? 48 : 0 }}
              >
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <div style={{
                    ...
                    height: 28,
                    borderRadius: '50%',
                    background: activeStage === i ? 'var(--accent)' : 'var(--bg-elevated)',
                ...
                <p className="text-body" style={{ paddingLeft: 40 }}>
                  {stage.description}
                </p>
              </motion.div>
            ))}
