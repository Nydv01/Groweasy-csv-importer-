...
export function ContainerScroll({
  ...
  // As the user scrolls down (scrollYProgress goes to 0.6), the card tilts backward and zooms out (scales down)
...
export function Card({
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto w-full border border-glass p-2 md:p-4 bg-glass rounded-[24px] shadow-2xl backdrop-blur-md"
    >
