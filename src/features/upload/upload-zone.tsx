...
export function UploadZone() {
  ...
  return (
    <section style={{ maxWidth: 720, margin: '0 auto', padding: '100px 24px 40px' }}>
      {/* Hero headline */}
        ...
        {!isFileAccepted && (
          ...
          >
            ...
            <motion.p
              ...
              style={{ marginTop: 10, maxWidth: 440, margin: '10px auto 0' }}
              initial={reducedMotion ? {} : { opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ ...motionPresets.spatial, delay: 0.5 }}
            >
              Preview locally first. Confirm manually. AI processes only when you&apos;re ready.
            </motion.p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence mode="wait">
        {!isFileAccepted ? (
          <motion.div
            ...
            exit={reducedMotion ? { opacity: 0 } : { opacity: 0, scale: 0.93, y: -15 }}
            transition={motionPresets.cinematic}
          >
            <div
        ...
        >
          {[
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ ...motionPresets.standard, delay: 0.6 + i * 0.1 }}
              style={{
